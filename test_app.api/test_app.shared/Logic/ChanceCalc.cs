...
namespace test_app.shared.Logic
{
    public class ChanceCalc
    {
        ...
        public List<SkinViewModel> Calc(double margine, double case_price, List<SkinViewModel> skinPool, List<SkinViewModel> ignoreSkinPool)
        {
            _marginality = margine;
            _casePrice = case_price;
            _skinsPool = skinPool;
            _ignoredSkins = ignoreSkinPool;
